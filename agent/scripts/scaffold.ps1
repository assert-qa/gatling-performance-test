...
#
# Advanced usage:
# - Supports Java, Kotlin, Scala, TypeScript, JavaScript (with correct structure and config)
# - Follows the 5-block pattern (Protocol, Feeders, Scenario, Injection, Assertions)
# - Parameterize all environment variables for CI/CD and cloud runs
# - For advanced modularization, see reference/design-patterns.md
# - For protocol-specific setup (WebSocket, MQTT, JMS), see reference/protocols.md
# - For best practices and troubleshooting, see ../SKILL.md and reference/playbook.md
#
# Troubleshooting:
# - If build fails, check for missing plugins, wrong file locations, or missing JVM args (Java 21+ needs extra flags)
...
#
# ---
# _Update this script as new Gatling features, languages, or best practices emerge._
