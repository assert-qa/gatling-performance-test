...
#
# Advanced usage:
# - Checks for 5-block pattern, best practices, and common mistakes
# - Validates Java, Kotlin, Scala, TypeScript, and JavaScript projects
...
# - Review warnings for missing assertions, pauses, or feeders
#
# Maintenance:
