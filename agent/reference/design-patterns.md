...
## Advanced Guidance & Best Practices
...
- See [../SKILL.md](../SKILL.md) for the full skill guide, 5-block pattern, and common mistakes.
- See [playbook.md](playbook.md) for project structure, CI/CD, and advanced usage.

---

_Update this guide as new Gatling features, patterns, or best practices emerge._
